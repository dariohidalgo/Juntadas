...
export default function EditExpenseScreen() {
    ...
    const { user } = useAuth();
    const { getGroup, updateExpense, deleteExpense } = useData();
    const { t } = useLang();
    ...
    const [paidById, setPaidById] = useState(expense?.paidById || user?.uid || "");
    const [splitAmongIds, setSplitAmongIds] = useState<string[]>(expense?.splitAmongIds || group?.memberIds || []);
    ...
    const handleSave = () => {
        ...
        updateExpense(id as string, expenseId as string, description, parseFloat(amount), paidById, splitAmongIds);
        handleBack();
    };
    ...
    return (
        ...
        >
            ...
            <View style={styles.header}>
                ...
                <Text style={styles.headerTitle}>{t("edit_expense")}</Text>
